...
async function setup(page: Page, options: { strategy?: ProductInventoryStrategy; permission?: "none" | "view" | "edit"; empty?: boolean } = {}) {
  ...
  await page.route("**/api/**", async route => {
    ...
    if (path === "/api/auth/me") return route.fulfill({ json: {
      ...
      permissions: options.permission === "none" ? [] : options.permission === "view"
        ? ["inventory_planning:view"] : ["inventory_planning:view", "inventory_planning:edit"], roles: [],
    } });
