  ...
  async getPickQueueOrders(): Promise<(Order & { items: OrderItem[] })[]> {
    ...
    const orderList = await db.execute(sql`
      SELECT
        ...
        o.completed_at,
        o.exception_at,
        o.exception_resolution AS exception_type,
        o.exception_notes,
        o.exception_resolved_at AS resolved_at,
        o.exception_resolved_by AS resolved_by,
        o.exception_notes AS resolution_notes,
        o.item_count,
        o.unit_count,
        o.total_cents AS total_amount,
        o.currency,
