...
export const DEFAULT_PERMISSIONS: InsertAuthPermission[] = [
  ...
  { resource: "inventory_planning", action: "view", description: "View inventory availability master data and draft evidence", category: "inventory" },
  { resource: "inventory_planning", action: "edit", description: "Create and edit inventory availability drafts", category: "inventory" },
  { resource: "inventory_planning", action: "activate", description: "Activate validated inventory availability authority", category: "inventory" },
