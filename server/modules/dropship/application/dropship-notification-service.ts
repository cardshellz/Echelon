...
export const DROPSHIP_LAUNCH_NOTIFICATION_PREFERENCES: DropshipLaunchNotificationPreferenceDefinition[] = [
  ...
  { eventType: DROPSHIP_NOTIFICATION_EVENTS.LISTING_TIER_HELD, critical: true },
  { eventType: DROPSHIP_NOTIFICATION_EVENTS.LISTING_TIER_RELEASED, critical: false },
  ...
  { eventType: DROPSHIP_NOTIFICATION_EVENTS.ORDER_INTAKE_DEGRADED, critical: true },
  { eventType: DROPSHIP_NOTIFICATION_EVENTS.ORDER_INTAKE_STOPPED, critical: true },
  { eventType: DROPSHIP_NOTIFICATION_EVENTS.ORDER_INTAKE_RECOVERED, critical: false },
  ...
  { eventType: DROPSHIP_NOTIFICATION_EVENTS.USDC_DEPOSIT_LANDED, critical: false },
  { eventType: DROPSHIP_NOTIFICATION_EVENTS.USDC_DEPOSIT_VOIDED, critical: true },
];
