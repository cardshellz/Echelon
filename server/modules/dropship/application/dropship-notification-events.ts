export const DROPSHIP_NOTIFICATION_EVENTS = {
  ...
  LISTING_TIER_GRACE_NOTICE: "dropship_listing_tier_grace_notice",
  LISTING_TIER_HELD: "dropship_listing_tier_held",
  LISTING_TIER_RELEASED: "dropship_listing_tier_released",
  ORDER_ACCEPTED: "dropship_order_accepted",
  ORDER_INTAKE_REJECTED: "dropship_order_intake_rejected",
  ORDER_INTAKE_DEGRADED: "dropship_order_intake_degraded",
  ORDER_INTAKE_STOPPED: "dropship_order_intake_stopped",
  ORDER_INTAKE_RECOVERED: "dropship_order_intake_recovered",
