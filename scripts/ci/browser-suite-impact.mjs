...
export const BROWSER_SUITES = {
  ...
  dropship: {
    ...
    tests: /^test\/browser\/(?:dropship-(?:pricing|content|policy)-.*\.ts|dropship-shipping-estimate\.spec\.ts|dropship-wallet\.spec\.ts|dropship-orders\.spec\.ts|dropship-onboarding\.spec\.ts|shared-shipping-configuration\.spec\.ts)$/,
    ...
    roots: [
      ...
      "dropship-orders", "dropship-onboarding", "shared-shipping-configuration",
