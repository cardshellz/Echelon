...
export const dropshipAutoReloadSettings = dropshipSchema.table(
  "dropship_auto_reload_settings",
  {
    ...
    // The vendor's choice for their rewards points: true applies them to
    // orders, false saves them, NULL means not chosen yet and reads as on,
    // the default (migration 0704; owner decision 2026-09-26).
