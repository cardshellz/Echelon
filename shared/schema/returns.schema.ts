...
export const returnLogisticsStatuses = ["not_required", "awaiting_return", "label_ready", "in_transit", "delivered", "received"] as const;
export type ReturnLogisticsStatus = typeof returnLogisticsStatuses[number];
export const returnInspectionStatuses = ["not_required", "pending", "approved", "rejected"] as const;
