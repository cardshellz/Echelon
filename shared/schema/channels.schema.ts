...
// ---------------------------------------------------------------------------
// Channel Pricing Rules — hierarchical global & channel-specific overrides
// ---------------------------------------------------------------------------

export const channelPricingRules = channelsSchema.table("channel_pricing_rules", {
  id: integer("id").primaryKey().generatedAlwaysAsIdentity(),
...
export type ChannelPricingRule = typeof channelPricingRules.$inferSelect;
