...
export const transactionTypeEnum = [
  ...
  "receipt_reversal", // Compensating reversal of a posted receipt (Spec D)
] as const;
...
export const warehouseSettings = inventorySchema.table("warehouse_settings", {
  ...
  autoDraftPoReviewWarningDays: integer("auto_draft_po_review_warning_days").notNull().default(2),
  autoDraftPoReviewCriticalDays: integer("auto_draft_po_review_critical_days").notNull().default(5),
  autoDraftPoSupplierSendWarningDays: integer("auto_draft_po_supplier_send_warning_days").notNull().default(2),
  autoDraftPoSupplierSendCriticalDays: integer("auto_draft_po_supplier_send_critical_days").notNull().default(5),
  autoDraftPoSupplierFollowupWarningDays: integer("auto_draft_po_supplier_followup_warning_days").notNull().default(7),
  autoDraftPoSupplierFollowupCriticalDays: integer("auto_draft_po_supplier_followup_critical_days").notNull().default(14),
  autoDraftPoReceivingWarningDays: integer("auto_draft_po_receiving_warning_days").notNull().default(3),
  autoDraftPoReceivingCriticalDays: integer("auto_draft_po_receiving_critical_days").notNull().default(10),
  autoDraftPoApCloseoutWarningDays: integer("auto_draft_po_ap_closeout_warning_days").notNull().default(7),
  autoDraftPoApCloseoutCriticalDays: integer("auto_draft_po_ap_closeout_critical_days").notNull().default(21),
  autoDraftPoExceptionWarningDays: integer("auto_draft_po_exception_warning_days").notNull().default(1),
  autoDraftPoExceptionCriticalDays: integer("auto_draft_po_exception_critical_days").notNull().default(3),
  autoDraftPoCloseoutWarningDays: integer("auto_draft_po_closeout_warning_days").notNull().default(7),
  autoDraftPoCloseoutCriticalDays: integer("auto_draft_po_closeout_critical_days").notNull().default(14),
  ...
  // timezone DB columns added in migration 100 are now dead and dropped from
  // this model so nothing reads them; a follow-up migration removes them.
  isActive: integer("is_active").notNull().default(1),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
}, (table) => [
