...
- The PostgreSQL CI manifest grows from 89 to 90 files. Reduced schema fixtures include the new columns so Drizzle reads exercise the same field contract.
