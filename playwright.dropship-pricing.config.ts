...
export default defineConfig({
  testDir: "./test/browser", testMatch: ["dropship-pricing-*.spec.ts", "dropship-content-*.spec.ts", "dropship-policy-*.spec.ts", "dropship-shipping-estimate.spec.ts"], fullyParallel: false, workers: 1,
