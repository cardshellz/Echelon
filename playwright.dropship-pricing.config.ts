...
export default defineConfig({
  testDir: "./test/browser", testMatch: ["dropship-pricing-*.spec.ts", "dropship-content-*.spec.ts", "dropship-policy-*.spec.ts", "dropship-shipping-estimate.spec.ts", "dropship-wallet.spec.ts", "dropship-orders.spec.ts", "shared-shipping-configuration.spec.ts"], fullyParallel: false, workers: 1,
