...
export default function InventoryHistory() {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6" data-testid="inventory-history-page">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="page-title">Inventory History</h1>
          <p className="text-muted-foreground">View complete audit trail of all inventory movements</p>
        </div>
